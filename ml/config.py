...
FRAME_HEIGHT = 1080
TARGET_FPS = 90
EXPOSURE = -6          # ~1/64s. Tune per ARCHITECTURE.md guidance (-5 to -7)
...
# ------------------------------------------------------------------
# Order MUST match your Roboflow class order / data.yaml
SCOUT_CLASSES = [
    "ball",
...
# Blue defends the x=0 end, Red defends the x=1 end (swap if your
